...
class WithdrawCoursesPage extends StatelessWidget {
              ...
              child: ListView(
                children: [
                  ...
                  if (controller.registeredSubjects.isEmpty)
                    const Text("No registered courses.",
                  ...
                  if (controller.withdrawnSubjects.isEmpty)
                    const Text("No courses withdrawn yet.",
                        style: TextStyle(color: Colors.black54))
                  else
  ...
  void _confirmWithdraw(
      BuildContext context, WithdrawCoursesController controller, Subject subject) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
        title: const Text("Confirm Withdrawal"),
        content: Text("Are you sure you want to withdraw from '${subject.name}'?"),
        actions: [
          TextButton(
